...
*** Test Cases ***
235057-【回归测试】超级管理员--任务管理根据终端下发系统更新任务
...
235056-【回归测试】超级管理员--任务管理根据区域下发系统更新任务
    ${cmsweb}=    Get Single Option Value    common    cmsweb
    ${browser}=    Get Single Option Value    common    browser
    ${login_user}=    Get Single Option Value    common    adminuser
    ${login_passwd}=    Get Single Option Value    common    adminpasswd
...
235053-【回归测试】超级管理员--终端中心单个终端下发系统更新任务
    ${cmsweb}=    Get Single Option Value    common    cmsweb
    ${browser}=    Get Single Option Value    common    browser
    ${login_user}=    Get Single Option Value   common    adminuser
    ${login_passwd}=    Get Single Option Value    common    adminpasswd
    ...
    Run Cmd    ${loginit}
    Login Cms   ${cmsweb}    ${login_user}    ${login_passwd}
    Do Task From Clent Center    ${clientname}
    Wait Until Keyword Succeeds    1 min    10 sec    Run Cmd Should Be Contain   ${updatecheckcmd}   apt-get
    Close All Browsers

235055-【回归测试】超级管理员--终端详情页下发系统更新任务
    ${cmsweb}=    Get Single Option Value    common    cmsweb
    ${browser}=    Get Single Option Value    common    browser
    ${login_user}=    Get Single Option Value   common    adminuser
    ${login_passwd}=    Get Single Option Value    common    adminpasswd
...
235050-【回归测试】超级管理员--区域详情仪表盘下发系统更新任务
    ${cmsweb}=    Get Single Option Value    common    cmsweb
    ${browser}=    Get Single Option Value    common    browser
    ${login_user}=    Get Single Option Value   common    adminuser
    ${login_passwd}=    Get Single Option Value    common    adminpasswd
...
235051-【回归测试】超级管理员--区域详情下发系统更新任务
    ${cmsweb}=    Get Single Option Value    common    cmsweb
    ${browser}=    Get Single Option Value    common    browser
    ${login_user}=    Get Single Option Value   common    adminuser
    ${login_passwd}=    Get Single Option Value    common    adminpasswd
...
235048-【回归测试】超级管理员--任务管理根据区域更新软件
    ${cmsweb}=    Get Single Option Value    common    cmsweb
    ${browser}=    Get Single Option Value    common    browser
    ${login_user}=    Get Single Option Value    common    adminuser
    ${login_passwd}=    Get Single Option Value    common    adminpasswd
...
235044-【回归测试】超级管理员--在终端中心单个终端更新软件
    ${cmsweb}=    Get Single Option Value    common    cmsweb
    ${browser}=    Get Single Option Value    common    browser
    ${login_user}=    Get Single Option Value    common    adminuser
    ${login_passwd}=    Get Single Option Value    common    adminpasswd
