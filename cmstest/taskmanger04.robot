...
*** Test Cases ***
235096-【回归测试】web二级管理员--下发立即执行的脚本下发任务
...
235097-【回归测试】web二级管理员--下发定时执行的脚本下发任务
    ${cmsweb}=    Get Single Option Value     common    cmsweb
    ${browser}=    Get Single Option Value     common    browser
    ${login_user}=    Get Single Option Value    secondaryadministrator    webadmin01
    ${login_passwd}=    Get Single Option Value     secondaryadministrator    webpasswd01
...
235098-【回归测试】web二级管理员--下发周期执行的脚本下发任务
    ${cmsweb}=    Get Single Option Value     common    cmsweb
    ${browser}=    Get Single Option Value     common    browser
    ${login_user}=    Get Single Option Value    secondaryadministrator    webadmin01
    ${login_passwd}=    Get Single Option Value     secondaryadministrator    webpasswd01
...
235093-【回归测试】web二级管理员--下发立即执行的系统更新任务
    ${cmsweb}=    Get Single Option Value     common    cmsweb
    ${browser}=    Get Single Option Value     common    browser
    ${login_user}=    Get Single Option Value    secondaryadministrator    webadmin01
    ${login_passwd}=    Get Single Option Value     secondaryadministrator    webpasswd01
...
235094-【回归测试】web二级管理员--下发定时执行的系统更新任务
    ${cmsweb}=    Get Single Option Value     common    cmsweb
    ${browser}=    Get Single Option Value     common    browser
    ${login_user}=    Get Single Option Value    secondaryadministrator    webadmin01
    ${login_passwd}=    Get Single Option Value     secondaryadministrator    webpasswd01
...
235095-【回归测试】web二级管理员--下发周期执行的系统更新任务
    ${cmsweb}=    Get Single Option Value     common    cmsweb
    ${browser}=    Get Single Option Value     common    browser
    ${login_user}=    Get Single Option Value    secondaryadministrator    webadmin01
    ${login_passwd}=    Get Single Option Value     secondaryadministrator    webpasswd01
...
235090-【回归测试】web二级管理员--下发立即执行的软件更新任务
    ${cmsweb}=    Get Single Option Value     common    cmsweb
    ${browser}=    Get Single Option Value     common    browser
    ${login_user}=    Get Single Option Value    secondaryadministrator    webadmin01
    ${login_passwd}=    Get Single Option Value     secondaryadministrator    webpasswd01
...
235091-【回归测试】web二级管理员--下发定时执行的软件更新任务
    ${cmsweb}=    Get Single Option Value     common    cmsweb
    ${browser}=    Get Single Option Value     common    browser
    ${login_user}=    Get Single Option Value    secondaryadministrator    webadmin01
    ${login_passwd}=    Get Single Option Value     secondaryadministrator    webpasswd01
...
235092-【回归测试】web二级管理员--下发周期执行的软件更新任务
    ${cmsweb}=    Get Single Option Value     common    cmsweb
    ${browser}=    Get Single Option Value     common    browser
    ${login_user}=    Get Single Option Value    secondaryadministrator    webadmin01
    ${login_passwd}=    Get Single Option Value     secondaryadministrator    webpasswd01
